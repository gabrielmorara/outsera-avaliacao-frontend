...
import { MovieService, ProducerInterval, StudioWins, YearWins, Movie } from '../movie.service';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    this.movieService.getYearsWithMultipleWinners().subscribe((years: YearWins[]) => {
